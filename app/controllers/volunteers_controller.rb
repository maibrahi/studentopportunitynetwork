class VolunteersController < ApplicationController
  ...
  def require_permission
    unless current_user == Volunteer.find(params[:id]).user || current_user.admin?
  ...
  private
    ...
    def volunteer_params
      params.require(:volunteer).permit(:title, :type, :company_name, :closing_date, :starting_date, :description_text, :location, :confirmed)
    end
end
